...
var __component = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { observer, snapshot, selectedPath, showDetails, details, query, lastUpdated, error, get timer() {
      return timer;
    }, set timer(v) {
      timer = v;
    }, typeCount, visibleActors, selected, tickingCount, parse, refresh, select, toggleDetails };
