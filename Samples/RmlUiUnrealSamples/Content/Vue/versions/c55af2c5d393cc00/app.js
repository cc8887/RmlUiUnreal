            ...
            renderList($setup.state.projects, (project) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", { class: "project-heading" }, [
                  ...
                  createBaseVNode("button", {
                    id: "vue-remove-" + project.id,
                    class: "remove",
                    onClick: withModifiers(($event) => $setup.removeProject(project.id), ["stop"])
                  }, "Remove", 8, ["id", "onClick"])
                ]),
                ...
                createBaseVNode("div", { class: "track" }, [
                  createBaseVNode(
                    ...
                    {
                      class: "fill",
                      style: normalizeStyle({ width: project.progress + "%" })
                    },
                    null,
                    4
                    /* STYLE */
                ...
                createBaseVNode(
                  "p",
                  { class: "percentage" },
                  toDisplayString(project.progress) + "%",
                  1
                  /* TEXT */
                )
              ], 8, ["id"]);
